...
func NewConfiguredRegistry(
	...
	manifests, err := ConfiguredManifests(cfg, auditHandler, apiKeyHandler, userHandler, organizationHandler)
	if err != nil {
		return nil, err
	}
...
func OptionalManifests(organizationHandler *organization.Handler) []assembly.StarterManifest {
...
func ConfiguredManifests(
	...
	catalog, err := NewCatalog(
		...
		OptionalManifests(organizationHandler),
	)
	if err != nil {
		return nil, err
	}
