...
func TestDefaultManifestsRegisterDefaultAssets(t *testing.T) {
	...
	assert.Equal(t, "trend", manifests[2].Name())
	assert.Equal(t, "user", manifests[3].Name())
	...
	assert.Contains(t, migrations, "2026_07_02_000000_create_content_pipeline_tables")
