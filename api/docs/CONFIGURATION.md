...
`organization`, `permission`, `notification`, `asset`, and `setting`; permission and setting
explicitly depend on organization, while notification and asset can be selected independently:
