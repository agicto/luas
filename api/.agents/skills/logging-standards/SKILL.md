...
See [`.agents/skills/logging-standards/examples/logging-setup.go`](./examples/logging-setup.go)
...
```bash
.agents/skills/logging-standards/scripts/validate-logging.sh <module_name>
```
