...
# 4. 查看示例
cat .agents/skills/module-creation/examples/blog-module-example.md
```
...
- [x] `.agents/skills/README.md` - Skills 主文档
- [x] `.agents/skills/_template/SKILL.md` - Skill 模板
- [x] `.agents/skills/module-creation/SKILL.md` - 模块创建工作流
- [x] `.agents/skills/module-creation/scripts/validate-module.sh` - 验证脚本
- [x] `.agents/skills/module-creation/examples/blog-module-example.md` - 示例
...
| 使用 Skills 系统 | [.agents/skills/README.md](../.agents/skills/README.md) |
| 创建新 Skill | [_template/SKILL.md](../.agents/skills/_template/SKILL.md) |
| 创建 DDD 模块 | [module-creation/SKILL.md](../.agents/skills/module-creation/SKILL.md) |
| 查看 Blog 示例 | [blog-module-example.md](../.agents/skills/module-creation/examples/blog-module-example.md) |
