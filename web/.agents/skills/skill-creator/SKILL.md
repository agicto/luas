---
name: skill-creator
description: Guide for creating or updating a Codex skill (SKILL.md frontmatter, scripts, references). Use when the user wants to author a new skill or refine an existing one.
---
